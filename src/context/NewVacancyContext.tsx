...
const defaultNewVacancyData: NewVacancyInitialValuesType = {
  ...
  companyCulture: ``,
  jobTitle: '',
  jobDescription: `<h3>Who we are</h3><p>Etisalat by e& is one of the leading telecom groups in the emerging markets...</p><br><h3>What we do</h3><p>We provide telecom, digital, and ICT solutions to individuals and businesses...</p><br><h3>Our mission</h3><p>To drive the digital future and empower societies...</p><br><h3>Our vision</h3><p>To be the leading digital solutions provider globally...</p><br>`,
  nonNegotiables: [],
  workMode: 'On-site',
  baseLocation: '',
  hireType: 'Permanent',
