      ...
      <Container>
        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6">
            <Link href="#" className="group" aria-label="Longlister on X">
              <svg
                className="h-6 w-6 fill-slate-500 group-hover:fill-brand-red"
                aria-hidden="true"
                viewBox="0 0 24 24"
              >
            ...
            <Link href="#" className="group" aria-label="Longlister on GitHub">
              <svg
                className="h-6 w-6 fill-slate-500 group-hover:fill-brand-red"
                aria-hidden="true"
                viewBox="0 0 24 24"
