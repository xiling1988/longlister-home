...
export default function RecruiterSection() {
  return (
    <section id="recruiters" className="bg-brand-cream py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl sm:text-center">
          <h6 className="font-semibold text-brand-red">Recruiters</h6>
          <h2 className="text-5xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-6xl sm:text-balance">
            ...
            <span className="relative whitespace-nowrap text-brand-red">
              <svg
                aria-hidden="true"
                viewBox="0 0 418 42"
                className="absolute top-2/3 left-0 mt-1 h-[0.58em] w-full fill-brand-coral"
  ...
  return (
    ...
    >
      <div
        className={clsx(
          'w-9 rounded-lg',
          isActive ? 'bg-brand-red' : 'bg-slate-500',
        )}
      >
      ...
      <h3
        className={clsx(
          'mt-6 text-lg leading-6 font-medium tracking-wide',
      ...
      <p
        className={clsx(
          'font-display text-md mt-2',
          isActive ? 'text-brand-coral' : 'text-slate-600',
        )}
      >
        {feature.summary}
      </p>
    ...
    <TabGroup className="hidden lg:mt-20 lg:block">
      {({ selectedIndex }) => (
        <>
          ...
          <TabPanels className="relative mt-12 overflow-hidden rounded-4xl bg-slate-200 px-14 py-16 xl:px-16">
